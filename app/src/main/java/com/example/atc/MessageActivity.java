...
import com.example.atc.Notification.Client;
import com.example.atc.Notification.Data;
import com.example.atc.Notification.MyResponse;
import com.example.atc.Notification.Sender;
import com.example.atc.Notification.Token;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MessageActivity.this, Find_friends.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
            }
        });
